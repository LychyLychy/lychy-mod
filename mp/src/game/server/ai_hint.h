...
enum Hint_e
{
	...
	HINT_URBAN_STREETCORNER = 200,
	HINT_URBAN_STREETLAMP,
	HINT_URBAN_DARK_SPOT,
	HINT_URBAN_POSTER,
	HINT_URBAN_SHELTER,

	HINT_ASSASSIN_SECLUDED = 300,
	HINT_ASSASSIN_RAFTERS,
	HINT_ASSASSIN_GROUND,
	HINT_ASSASSIN_MONKEYBARS,
