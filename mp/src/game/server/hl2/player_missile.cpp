...
void CPlayer_Missile::BlowUp(void)
{
	...
	RadiusDamage ( CTakeDamageInfo( this, this, m_flDamage, DMG_BLAST ), GetAbsOrigin(), m_flDamageRadius, CLASS_NONE , this);
...
void CPlayer_Missile::LoseMissileControl(void)
{
	...
	if ( pGrenade )
	{
		...
		((SmokeTrail*)(CBaseEntity*)m_hSmokeTrail)->FollowEntity(pGrenade);
	}
