...
class CNPC_CitizenBeta : public CAI_PlayerAllyBeta
{
	DECLARE_CLASS( CNPC_CitizenBeta, CAI_PlayerAllyBeta );
...
//---------------------------------------------------------
//---------------------------------------------------------
inline bool CNPC_CitizenBeta::NearCommandGoal()
{
...
//---------------------------------------------------------
//---------------------------------------------------------
inline bool CNPC_CitizenBeta::VeryFarFromCommandGoal()
{
