...
FACTORYCMD(lychy_combine_s_beta, "npc_combine_s", "npc_combine_s_beta");
extern ConVar sk_combine_s_kick;
extern ConVar sk_combine_s_health;
extern ConVar combine_spawn_health;

LINK_ENTITY_TO_CLASS( npc_combine_s_beta, CNPC_CombineSBeta );

ConVar lychy_combine_s_model("lychy_combine_s_model", "models/combine_soldier_beta.mdl");
...
//
//-----------------------------------------------------------------------------
void CNPC_CombineSBeta::Spawn( void )
{
	Precache();
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_CombineSBeta::Precache()
{

	engine->PrecacheModel(lychy_combine_s_model.GetString());
...
void CNPC_CombineSBeta::DeathSound( const CTakeDamageInfo &info )
{
...
// Output :
//-----------------------------------------------------------------------------
void CNPC_CombineSBeta::MaintainLookTargets ( float flInterval )
{
...
//-----------------------------------------------------------------------------
void CNPC_CombineSBeta::ClearAttackConditions( )
{
...
void CNPC_CombineSBeta::PrescheduleThink( void )
{
...
//-----------------------------------------------------------------------------
void CNPC_CombineSBeta::BuildScheduleTestBits( void )
{
...
// Output :
//-----------------------------------------------------------------------------
int CNPC_CombineSBeta::SelectSchedule ( void )
{
	if( HasCondition( COND_HEAR_PHYSICS_DANGER ) )
	{
...
// Output :
//-----------------------------------------------------------------------------
int CNPC_CombineSBeta::TakeDamage( const CTakeDamageInfo &info )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
int	CNPC_CombineSBeta::OnTakeDamage_Alive( const CTakeDamageInfo &info )
{
...
bool CNPC_CombineSBeta::FInAimCone( const Vector &vecSpot )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CNPC_CombineSBeta::HandleAnimEvent( animevent_t *pEvent )
{
	switch( pEvent->event )
	{
...
void CNPC_CombineSBeta::OnChangeActivity( Activity eNewActivity )
{
...
void CNPC_CombineSBeta::OnListened()
{
...
//-----------------------------------------------------------------------------
void CNPC_CombineSBeta::Event_Killed( const CTakeDamageInfo &info )
{
...
BEGIN_DATADESC( CNPC_BounceBomb )
	...
	DEFINE_KEYFIELD( m_flWarnRadius,		FIELD_FLOAT, "WarnRadius" ),
	DEFINE_KEYFIELD( m_flDetonateRadius,	FIELD_FLOAT, "DetonateRadius" ),
	DEFINE_KEYFIELD( m_flExplosionRadius,	FIELD_FLOAT, "ExplosionRadius" ),
	...
	DEFINE_FIELD(  m_hNearestBCC, FIELD_EHANDLE ),
...
LINK_ENTITY_TO_CLASS( bounce_bomb_beta, CNPC_BounceBomb );
LINK_ENTITY_TO_CLASS( combine_bouncemine_beta, CNPC_BounceBomb );
LINK_ENTITY_TO_CLASS( combine_mine_beta, CNPC_BounceBomb );
