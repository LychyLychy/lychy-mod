...
//=============================================================================
// >> CNPCSimpleTalkerBeta
//=============================================================================

class CAI_PlayerAllyBeta : public CAI_BaseActor
{
	DECLARE_CLASS( CAI_PlayerAllyBeta, CAI_BaseActor );
public:
	// AI functions
...
private:
	...
	virtual void	SetAnswerQuestion( CAI_PlayerAllyBeta *pSpeaker );
...
class CNPCSimpleTalkerBeta : public CAI_PlayerAllyBeta
{
	DECLARE_CLASS( CNPCSimpleTalkerBeta, CAI_PlayerAllyBeta );
public:
