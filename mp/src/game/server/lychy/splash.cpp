...
#define SPLASH_ENTITYNAME		"env_splash_beta"
...
LINK_ENTITY_TO_CLASS(env_splash_beta, CSplash);

BEGIN_DATADESC( CSplash )

	DEFINE_KEYFIELD(  m_flSpawnRate,		FIELD_FLOAT,	"spawnrate" ),
	DEFINE_KEYFIELD(  m_rgbaStartColor,		FIELD_COLOR32,	"startcolor" ),
	DEFINE_KEYFIELD(  m_rgbaEndColor,		FIELD_COLOR32,	"endcolor" ),
	DEFINE_KEYFIELD(  m_flSpeed,			FIELD_FLOAT,	"speed" ),
	DEFINE_KEYFIELD(  m_flSpeedRange,		FIELD_FLOAT,	"speedrange" ),
	DEFINE_KEYFIELD(  m_flWidthMin,			FIELD_FLOAT,	"widthmin" ),
	DEFINE_KEYFIELD(  m_flWidthMax,			FIELD_FLOAT,	"widthmax" ),
	DEFINE_KEYFIELD(  m_flNoise,			FIELD_FLOAT,	"noise" ),
	DEFINE_KEYFIELD(  m_flParticleLifetime,	FIELD_FLOAT,	"lifetime" ),
	DEFINE_KEYFIELD(  m_bEmit,				FIELD_BOOLEAN,	"startactive" ),
	DEFINE_KEYFIELD(  m_nNumDecals,			FIELD_INTEGER,	"numdecals" ),

	DEFINE_FIELD( m_vStartColor, FIELD_VECTOR ),
	DEFINE_FIELD( m_vEndColor, FIELD_VECTOR ),
	DEFINE_FIELD( m_flStopEmitTime, FIELD_TIME ),

	DEFINE_INPUTFUNC( FIELD_FLOAT, "SetSpawnRate", InputSetSpawnRate ),
	DEFINE_INPUTFUNC( FIELD_FLOAT, "SetSpeed", InputSetSpeed ),
	DEFINE_INPUTFUNC( FIELD_FLOAT, "SetNoise", InputSetNoise ),
	DEFINE_INPUTFUNC( FIELD_FLOAT, "SetLifetime", InputSetParticleLifetime ),
