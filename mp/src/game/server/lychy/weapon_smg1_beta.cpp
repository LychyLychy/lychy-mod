...
FACTORYCMD(lychy_smg1_beta, "weapon_smg1", "weapon_smg1_beta");

class CWeaponSMG1Beta : public CHLSelectFireMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS( CWeaponSMG1Beta, CHLSelectFireMachineGun );
...
IMPLEMENT_SERVERCLASS_ST(CWeaponSMG1Beta, DT_WeaponSMG1Beta)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_smg1_beta, CWeaponSMG1Beta );
PRECACHE_WEAPON_REGISTER(weapon_smg1_beta);

BEGIN_DATADESC( CWeaponSMG1Beta )
...
acttable_t	CWeaponSMG1Beta::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE(CWeaponSMG1Beta);

//=========================================================
CWeaponSMG1Beta::CWeaponSMG1Beta( )
{
	m_fMinRange1		= 64;
	m_fMaxRange1		= 1400;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSMG1Beta::Precache( void )
{
...
//-----------------------------------------------------------------------------
void CWeaponSMG1Beta::Equip( CBaseCombatCharacter *pOwner )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSMG1Beta::AddViewKick( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSMG1Beta::ItemPostFrame( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSMG1Beta::SecondaryAttack( void )
{
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponSMG1Beta::WeaponRangeAttack2Condition( float flDot, float flDist )
{
...
void CWeaponSMG1Beta::Spawn(void)
{
	SetClassname("weapon_smg1_beta");
	BaseClass::Spawn();
